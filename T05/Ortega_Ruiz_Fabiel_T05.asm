...
section .data
    file_name db "/home/fabiel/Documentos/Ensamblador/data.txt", 0
    output_file_name db "/home/fabiel/Documentos/Ensamblador/ORTEGA_RUIZ_FABIEL_COUNT.txt", 0
...
exit_program:
    ...
    ;nasm -f elf32 Ortega_Ruiz_Fabiel_T05.asm

    ;gcc -m32 Ortega_Ruiz_Fabiel_T05.o -o Ortega_Ruiz_FabielEjec -no-pie
