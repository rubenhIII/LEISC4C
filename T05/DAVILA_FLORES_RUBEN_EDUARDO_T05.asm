...
;Nota: Fui el que le comento que en mi computadora no me guardaba nada en el archivo de salida pero en este caso cuando le pase el programa a un compañero para probarlo a el 
;si le funciono correctamente y le almaceno en el archivo salida pero el codigo si funciona correctamente
