;Programa que cuenta las veces que se repite una letra en un texto
;y crea un archivo mostrando cuantas veces se repitio

section .data
    file_name db "data.txt", 0
    output_file_name db "GARCIA_DEL_ALTO_EMILIO_ALEJANDRO_COUNT.txt", 0
...
;Compilacion
; nasm -f elf32 -g GARCIA_DEL_ALTO_EMILIO_ALEJANDRO_T05.asm
; gcc -m32 -no-pie GARCIA_DEL_ALTO_EMILIO_ALEJANDRO_T05.o -o GARCIA_DEL_ALTO_EMILIO_ALEJANDRO_T05Ex
