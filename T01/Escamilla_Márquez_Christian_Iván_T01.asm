...
;Autor: Christian Iván Escamilla Márquez
;Fecha: 02/03/2023
...
.DATA
    ;Segmento de Datos
   Var1 DB  08h, 05h, 01h, 04h, 07h, 02h, 06h, 03h, '$'  ;vector 
.CODE
    ;Segmento de Codigo
...
impr1:   
        ...
        je cont             ;si es el final del array salta a cont
        print '['           ;pone corchete que abre
        ...
        print '] '          ;imprime corchete que cierra
        jmp impr1           ;loop
                                 
        
cont:   ;cuenta cuantos elementos hay en el vector
        cmp Var1[DI], '$'
        je  agr   ;si es el ultimo elemento salta a agr
        inc CX    ;si no es el ulitmo elemento le suma uno a CX
        inc DI    ;incrementa el registro DI
        jmp cont  ;salta a comp para incrementar DI
